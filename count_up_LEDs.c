...
#define PIN_BUTTON_IN 22 //physical pin 29 / gpio 22
...
int main() {
    ...
    gpio_set_irq_enabled_with_callback(PIN_BUTTON_IN, GPIO_IRQ_LEVEL_HIGH, true, &button_isr);
    ...
    int delay_in_ms = (rand() % (longest_delay + 1 - min_delay)) + min_delay;
